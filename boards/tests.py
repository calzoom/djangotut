...
class NewTopicTests(TestCase):
    ...
    # reverse url and check client request status code
    ...
    # resolve url to check it return the right view function
    # (make sure right view is used)
    def test_new_topic_url_resolves_new_topic_view(self):
        view = resolve("/boards/1/new/")
        self.assertEquals(view.func, new_topic)

    # check new_topic view contains nav back to list of topics
    ...
    # make sure a view contains the correct navigation links
    ...
    def test_csrf(self):  # test csrf is included
        url = reverse("new_topic", kwargs={"pk": 1})
        response = self.client.get(url)
